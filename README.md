...
![Blender tennis court scene objects](/images/blender_tennis_court.jpg)
  #### Tennis court 
...
![Blender character and animation](/images/blender_animation.jpg)
...
This are the major steps realised for the construction of the game, by combining the necessary knowledge with those acquired in college in various subjects and used especially to implement the code for game logic:
...
![Playground nodes](/images/playground_hierarchy.jpg)


#### [Game executable](/Scripts/Game.gd)
![Game hierarchy](/images/game_hierarchy.jpg)
...
![Menu](/images/start_menu_screen.jpg)

#### [Camera](/Scripts/Camera.gd)
The camera for viewing during the game is fixed and allows user to see all the elements of the game. 
![Gameplay view](/images/in_game.jpg)
...
![Free camera](/images/free_camera.jpg)
- gimbal stabilizer
...
-implementing camera rotation and zooming in with the mouse
![Free camera view](/images/free_freeze_camera_view.jpg)

#### [Tennis Ball](/Scripts/Ball.gd)
...
#### [Tennis player character](/Scripts/Character.gd)
...
#### [User player character](/Scripts/PC.gd)
...
Functions are having passed the *delta* parameter to set a smooth control of the player regardless of the amount of frames per second. Also, the direction of movement and the direction of aiming are normalized to ensure a constant translation.

#### [Racket](/Scripts/Racket.gd)
![Racket node](/images/racket_node.jpg)
...
#### [Non-player character](/Scripts/NPC.gd)
...
Here is implemented an intelligent agent who perceives the "environment" based on the state of play and will act automatically depending on the movement and position of the ball in order to intercept it and then depending on the position of the opponent on the field it aims and hits the ball accordingly.
![Intelligent agent](/images/intelligent_agent.jpg)


#### [Game logic](/Scripts/World.gd)
...
```
![Game states](/images/tennis_logic_states.jpg)

#### [Score](/Scripts/Score.gd)
